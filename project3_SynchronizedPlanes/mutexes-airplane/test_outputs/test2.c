...
3:GHOST
 ...
 -Plane 9: remove() FREE_RUNWAY has value 1
 -Plane 9: remove() pthread_mutex_lock(FREE_RUNWAY + plane->target_runway).
PLANE TARGET RUNWAY: 2, 1, 1, 1
 -Plane 9: finished remove()
<-------------------------------------------------->
  ---BUFFER---
GHOST
GHOST
...
1:DESCEND id:7	 t_start:1	 maxfuel:112	 n_fuel:112.000000	is_emergency:0	 state:2	 runway:0
2:DESCEND id:8	 t_start:1	 maxfuel:153	 n_fuel:153.000000	is_emergency:0	 state:2	 runway:1
3:ARRIVE id:9	 t_start:1	 maxfuel:180	 n_fuel:180.000000	is_emergency:0	 state:1
</------------------------------------------------->
DESCEND id:9	 t_start:1	 maxfuel:180	 n_fuel:180.000000	is_emergency:0	 state:2	 runway:2
...
1:DESCEND id:7	 t_start:1	 maxfuel:112	 n_fuel:112.000000	is_emergency:0	 state:2	 runway:0
2:DESCEND id:8	 t_start:1	 maxfuel:153	 n_fuel:153.000000	is_emergency:0	 state:2	 runway:1
3:DESCEND id:9	 t_start:1	 maxfuel:180	 n_fuel:180.000000	is_emergency:0	 state:2	 runway:2
</------------------------------------------------->
 -Plane 10: WAIT() loop.
...
3:DESCEND id:9	 t_start:1	 maxfuel:180	 n_fuel:180.000000	is_emergency:0	 state:2	 runway:2
 ...
 -Plane 1: WAIT() loop.
LANDING id:9	 t_start:1	 maxfuel:180	 n_fuel:180.000000	is_emergency:0	 state:3	 runway:2
...
Freeing runway 0, func ret: 0, 0, 1, 1 -Plane 7: descend_land() pthread_mutex_lock(SEM_WAIT_DONE).
...
3:LANDING id:9	 t_start:1	 maxfuel:180	 n_fuel:180.000000	is_emergency:0	 state:3	 runway:2
</------------------------------------------------->
 -Plane 10: WAIT() TURN_1
 -Plane 10: WAIT() critical region.
 -Plane 10: WAIT() TURN_2
 -Plane 10: WAIT() found all planes sleeping
 -Plane 10: WAIT() loop.
 -Plane 10: WAIT() TURN_1
 -Plane 11: WAIT() TURN_1
 -Plane 12: WAIT() TURN_1
 -Plane 13: WAIT() TURN_1
CLEARED id:9	 t_start:1	 maxfuel:180	 n_fuel:180.000000	is_emergency:0	 state:4	 runway:2
 -Plane 9: descend_land() FREE_RUNWAY has value 1
 -Plane 9: pthread_mutex_unlock(FREE_RUNWAY).
Freeing runway 2, func ret: 0, 0, 1, 0 -Plane 9: descend_land() pthread_mutex_lock(SEM_WAIT_DONE).
...
3:GHOST
 ...
 -Plane 8: descend_land() FREE_RUNWAY has value 1
 -Plane 8: pthread_mutex_unlock(FREE_RUNWAY).
Freeing runway 1, func ret: 1, 1, 0, 0 -Plane 8: descend_land() pthread_mutex_lock(SEM_WAIT_DONE).
...
Freeing runway 0, func ret: 0, 0, 1, 0 -Plane 10: WAIT() TURN_1
 -Plane 11: WAIT() TURN_1
 -Plane 12: WAIT() TURN_1
 -Plane 13: WAIT() TURN_1
 -Plane 14: WAIT() TURN_1
 ...
 -Plane 2: WAIT() FREE_RUNWAY has value 2
...
3:GHOST
 ...
 -Plane 2: remove() pthread_mutex_lock(FREE_RUNWAY + plane->target_runway).
PLANE TARGET RUNWAY: 2, 1, 1, 1
...
DESCEND id:2	 t_start:1	 maxfuel:100	 n_fuel:100.000000	is_emergency:1	 state:2	 runway:0
 -Plane 1: descend_land() pthread_mutex_lock(SEM_WAIT_DONE).
...
Freeing runway 0, func ret: 0, 0, 1, 1 -Plane 2: descend_land() pthread_mutex_lock(SEM_WAIT_DONE).
 ...
 -Plane 19: WAIT() TURN_1
 -Plane 4: WAIT() TURN_1
 -Plane 4: WAIT() found all planes awake
 -Plane 4: WAIT() critical region.
...
Freeing runway 0, func ret: 0, 0, 1, 1 -Plane 4: descend_land() pthread_mutex_lock(SEM_WAIT_DONE).
 ...
 -Plane 25: WAIT() TURN_1
 -Plane 5: WAIT() TURN_1
 -Plane 5: WAIT() found all planes awake
 -Plane 5: WAIT() critical region.
 -Plane 5: WAIT() found is_next()
 -Plane 5: WAIT() FREE_RUNWAY has value 1
 -Plane 5: WAIT() pthread_mutex_unlock(FREE_RUNWAY).
PLANE TARGET RUNWAY: 0, 1, 1, 1
 -Plane 5: WAIT() TURN_2
 -Plane 19: WAIT() critical region.
 -Plane 19: WAIT() TURN_2
 ...
 -Plane 25: WAIT() critical region.
 -Plane 25: WAIT() TURN_2
 -Plane 25: WAIT() found all planes sleeping
 -Plane 25: WAIT() loop.
 -Plane 5: plane_function:if: try to acquire SEM_BUFFER.
 -Plane 5: plane_function:if: acquired SEM_BUFFER.
 -Plane 5: remove() FREE_RUNWAY has value 0
...
Freeing runway 0, func ret: 0, 0, 1, 1 -Plane 5: descend_land() pthread_mutex_lock(SEM_WAIT_DONE).
 ...
 -Plane 25: WAIT() FREE_RUNWAY has value 1
...
PLANE TARGET RUNWAY: 0, 1, 1, 1
 ...
 -Plane 25: remove() FREE_RUNWAY has value 0
...
CLEARED id:25	 t_start:1	 maxfuel:172	 n_fuel:172.000000	is_emergency:1	 state:4	 runway:0
 -Plane 25: descend_land() FREE_RUNWAY has value 0
 -Plane 25: pthread_mutex_unlock(FREE_RUNWAY).
Freeing runway 0, func ret: 0, 0, 1, 1 -Plane 25: descend_land() pthread_mutex_lock(SEM_WAIT_DONE).
 -Plane 24: WAIT() TURN_1
 -Plane 23: WAIT() TURN_1
 -Plane 19: WAIT() TURN_1
 -Plane 3: WAIT() TURN_1
 ...
 -Plane 15: WAIT() TURN_2
 -Plane 6: WAIT() critical region.
 -Plane 6: WAIT() found is_next()
 -Plane 6: WAIT() FREE_RUNWAY has value 1
 -Plane 6: WAIT() pthread_mutex_unlock(FREE_RUNWAY).
PLANE TARGET RUNWAY: 0, 1, 1, 1
 -Plane 6: WAIT() TURN_2
 -Plane 16: WAIT() critical region.
 -Plane 16: WAIT() TURN_2
 ...
 -Plane 14: WAIT() loop.
 -Plane 15: WAIT() loop.
 -Plane 6: plane_function:if: try to acquire SEM_BUFFER.
 -Plane 6: plane_function:if: acquired SEM_BUFFER.
 -Plane 6: remove() FREE_RUNWAY has value 0
...
GHOST
  ...
  ---RUNWAYS---
1:ARRIVE id:6	 t_start:1	 maxfuel:157	 n_fuel:157.000000	is_emergency:1	 state:1
2:GHOST
3:GHOST
</------------------------------------------------->
DESCEND id:6	 t_start:1	 maxfuel:157	 n_fuel:157.000000	is_emergency:1	 state:2	 runway:0
 -Plane 16: WAIT() loop.
 -Plane 17: WAIT() loop.
 -Plane 18: WAIT() loop.
 -Plane 20: WAIT() loop.
...
GHOST
  ...
  ---RUNWAYS---
1:DESCEND id:6	 t_start:1	 maxfuel:157	 n_fuel:157.000000	is_emergency:1	 state:2	 runway:0
2:GHOST
3:GHOST
</------------------------------------------------->
LANDING id:6	 t_start:1	 maxfuel:157	 n_fuel:157.000000	is_emergency:1	 state:3	 runway:0
CLEARED id:6	 t_start:1	 maxfuel:157	 n_fuel:157.000000	is_emergency:1	 state:4	 runway:0
 -Plane 6: descend_land() FREE_RUNWAY has value 0
 -Plane 6: pthread_mutex_unlock(FREE_RUNWAY).
Freeing runway 0, func ret: 0, 0, 1, 1 -Plane 6: descend_land() pthread_mutex_lock(SEM_WAIT_DONE).
 -Plane 21: WAIT() TURN_1
 -Plane 22: WAIT() TURN_1
 -Plane 24: WAIT() TURN_1
 -Plane 23: WAIT() TURN_1
...
PLANE TARGET RUNWAY: 0, 1, 1, 1
 ...
 -Plane 18: WAIT() critical region.
 -Plane 18: WAIT() TURN_2
 -Plane 18: WAIT() found all planes sleeping
 -Plane 18: WAIT() loop.
 -Plane 20: WAIT() loop.
 -Plane 21: WAIT() loop.
 -Plane 22: WAIT() loop.
...
Freeing runway 0, func ret: 0, 0, 1, 1 -Plane 11: descend_land() pthread_mutex_lock(SEM_WAIT_DONE).
 ...
 -Plane 16: WAIT() TURN_1
 -Plane 17: WAIT() TURN_1
 -Plane 17: WAIT() found all planes awake
 -Plane 17: WAIT() critical region.
 -Plane 17: WAIT() TURN_2
 -Plane 18: WAIT() critical region.
 -Plane 18: WAIT() TURN_2
